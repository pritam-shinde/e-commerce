...
const Routing = ({category, products, onAddToCart, cart, handleUpdateCartItemQuantity, handleCartItemRemove, handleUpdateCartEmpty, handleCheckoutCapture}) => {
  return (
    <>
      <Routes>
        ...
        <Route path='/checkout/' element={<Checkout cart={cart} handleCheckoutCapture={handleCheckoutCapture} />} />
